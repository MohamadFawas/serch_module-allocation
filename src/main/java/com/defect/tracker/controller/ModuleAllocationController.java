...
public class ModuleAllocationController {
  ...
  @GetMapping(EndpointURI.MODULEALLOCATION_SEARCH)
  public ResponseEntity<Object> multiSearchModuleAllocation(@RequestParam(name = "page") int page,
      @RequestParam(name = "size") int size, @RequestParam(name = "sortField") String sortField,
      @RequestParam(name = "direction") String direction, ModuleAllocationSearch moduleAllocationSearch) {
    ...
    return ResponseEntity.ok(new PaginatedContentResponse<>(Constants.EMPLOYEE,
        moduleAllocationService.multiSearchModuleAllocation(pageable, pagination, moduleAllocationSearch),
        RequestStatus.SUCCESS.getStatus(), validationFailureResponseCode.getCommonSuccessCode(),
